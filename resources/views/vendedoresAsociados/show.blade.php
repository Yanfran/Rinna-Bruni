...
@section('contenido')
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <h3>Ver vendedor - Distribuidor: {{ $distribuidor->id }}
                {{-- @can('tiendas-list')  --}}
                ...
                <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ $distribuidor->name }} {{ $distribuidor->apellido_paterno }}" name=""
                                class="form-control"
                                placeholder="Distribuidor asociado" readonly>
                            </div>
                        </div>
                ...
                {{-- <div class="row">
                    ...
                    {{-- <div class="col-xs-12 col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="" value="{{ $vendedores->dia_credito }}"
                                class="form-control miles" placeholder="Días de credito" readonly>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $vendedores->credito }}" class="form-control" readonly>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-6">
                        <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <div class="contenedor-select">
                                <label class="text-md-right" for="color_1"><span class="requerido">* </span>
                                    Activación de vendedores de sistema</label>
                                <label class="switch">
