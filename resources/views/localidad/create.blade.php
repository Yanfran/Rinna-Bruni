                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="number" name="cp" class="form-control" placeholder="45600" pattern="[0-9]{5}" minlength="5" maxlength="5" required>
                          </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="municipio_id" class="form-control" id="municipio_id"
                                required>
