<div class="row mt-4">
    ...
    <div class="row row-no-gutters seccion-final">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6">
            ...
            <button id="btn-guardar" name="btn-guardar" type="submit" class="btn btn-info ml-1 pull-right d-none">Guardar</button>
            {{-- @if (\Auth::user()->isAdmin())
                <button id="btn-guardar" class="btn btn-info ml-1 pull-right d-none">Guardar</button>
            @else
                <button id="btn-solicitar" class="btn btn-info ml-1 pullpull-right d-none">Solicitar</button>
            @endif --}}
        </div>
    </div>
</div>
