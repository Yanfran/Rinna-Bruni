...
var DropSheet = function DropSheet(opts) {
    ...
    function fixdata(data) {
        ...
        for (; l < data.byteLength / w; ++l)
            o += String.xfromCharCode.apply(null, new Uint8Array(data.slice(l * w, l * w + w)));
        o += String.xfromCharCode.apply(null, new Uint8Array(data.slice(o.length)));
        return o;
    }
    ...
    window.fs = function choose_sheet(sheetidx) {
        process_wb(last_wb, sheetidx);
    }
